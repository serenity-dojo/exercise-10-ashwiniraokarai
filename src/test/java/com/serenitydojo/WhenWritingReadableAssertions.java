...
public class WhenWritingReadableAssertions {
    ...
    public void whenANumberIsCloseToAnotherValue() {
        ...
        Assertions.assertThat(roughlyOneHundred).isCloseTo(100.00, Percentage.withPercentage(10));
    }
    ...
    public void whenAStringIsEqualToAnother() {
        ...
        Assertions.assertThat(color).isEqualTo("red");
    }
    ...
    public void whenAStringIsEqualIgnoringCase() {
        ...
        Assertions.assertThat(color).isEqualToIgnoringCase("red");
    }
    ...
    public void whenAStringContainsOnlyDigits() {
        ...
        Assertions.assertThat(licenseNumber).containsOnlyDigits();
    }
    ...
    public void whenAListHasASpecificSize() {
        ...
        Assertions.assertThat(colors.size()).isEqualTo(3);
    }
    ...
    public void whenAListContainsExactlyASetOfValues() {
        ...
        Assertions.assertThat(colors).containsExactly("red","green","blue");
    }
    ...
    public void whenAListContainsExactlyASetOfValuesInAnyOrder() {
        ...
        Assertions.assertThat(colors).containsExactlyInAnyOrder("blue","green","red");
    }
